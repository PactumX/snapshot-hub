---------------------------------------
  ...
  Note: This project is forked from https://github.com/snapshot-labs/snapshot-hub, but
  we have changed the primary database code to work with postgres, because that fits
  better with our infrastructure than mysql
...
To load a space settings in the database you can go on this endpoint http://localhost:3000/api/spaces/yam.eth/poke (change yam.eth with the space you want to activate).# Welcome to StackEdit!
